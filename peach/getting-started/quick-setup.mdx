...
<Tabs sync={false} borderBottom>
  <Tab title="GitHub">
    <Steps>
      <Step title="Create a new docs project" id="create-a-new-docs-project">
        In the dashboard, create a new project and choose **Import from GitHub**.
      </Step>
      <Step title="Authorize repository access" id="authorize-repository-access">
      ...
      <Step title="Confirm your content root" id="confirm-your-content-root">
      ...
      <Step title="Review the generated navigation" id="review-the-generated-navigation">
  ...
  <Tab title="GitLab">
    <Steps>
      ...
      <Step title="Grant access to the correct group or repository" id="grant-access-to-the-correct-group-or-repository">
        Make sure the account you connect can read the branch that stores your content.
      </Step>
      <Step title="Choose the branch to publish from" id="choose-the-branch-to-publish-from">
        Use your default branch for production and let Mintlify create previews for merge requests.
      </Step>
      <Step title="Validate the imported structure" id="validate-the-imported-structure">
  ...
  <Tab title="Local preview">
    <Steps>
      ...
      <Step title="Open your docs directory" id="open-your-docs-directory">
        Move into the folder that contains `docs.json` and your MDX files.
      </Step>
      <Step title="Run a local preview" id="run-a-local-preview">
        ```bash
        mint dev
        ```
      </Step>
      <Step title="Iterate before you connect a repository" id="iterate-before-you-connect-a-repository">
